...
import {MerkleRoot} from "../contracts/MerkleRoot.sol";
...
contract MerkleRootDeploy is Script {
    function run() external {
        ...
        MerkleRoot merkleRoot = new MerkleRoot(verifier);
        console2.log("Deployed MerkleRoot to", address(merkleRoot));
